...
| 9  | [**RL4LMs**](https://github.com/allenai/RL4LMs) ⭐ 2,393 \| 🐛 53 \| 🌐 Python \| 📅 2024-03-01                                                                                          | A modular RL library to fine-tune language models to human preferences. Rigorously evaluated through 2000+ experiments using the GRUE benchmark, ensuring robustness across various NLP tasks.                                                                                                                                                                                                                      |
...
* 🔹 [ReAct (GitHub)](https://github.com/ysymyth/ReAct) ⭐ 4,114 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-02-06
...
Please raise any issues or questions [here](https://github.com/mbzuai-oryx/Awesome-LLM-Post-training/issues) ⭐ 2,522 | 🐛 15 | 🌐 Python | 📅 2026-07-27.
