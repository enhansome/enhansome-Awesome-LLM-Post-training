...
| 9  | [**RL4LMs**](https://github.com/allenai/RL4LMs) ⭐ 2,397 \| 🐛 53 \| 🌐 Python \| 📅 2024-03-01                                                                                          | A modular RL library to fine-tune language models to human preferences. Rigorously evaluated through 2000+ experiments using the GRUE benchmark, ensuring robustness across various NLP tasks.                                                                                                                                                                                                                      |
...
* 🔹 [ReAct (GitHub)](https://github.com/ysymyth/ReAct) ⭐ 4,191 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-02-06
* 🔹 [Decision Transformer (GitHub)](https://github.com/kzl/decision-transformer) ⭐ 2,836 | 🐛 37 | 🌐 Python | 📅 2024-04-29
...
Please raise any issues or questions [here](https://github.com/mbzuai-oryx/Awesome-LLM-Post-training/issues) ⭐ 2,563 | 🐛 20 | 🌐 Python | 📅 2026-09-05.
