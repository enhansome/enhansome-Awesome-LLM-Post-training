...
| 2  | [**LlamaGym**](https://github.com/KhoomeiK/LlamaGym) ⭐ 1,254 \| 🐛 10 \| 🌐 Python \| 📅 2024-03-19                                                                                     | Simplifies fine-tuning large language model (LLM) agents with online RL. Provides an abstract `Agent` class to handle various aspects of RL training, allowing for quick iteration and experimentation across different environments.                                                                                                                                                                               |
...
* 🔹 [ReAct (GitHub)](https://github.com/ysymyth/ReAct) ⭐ 4,123 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-02-06
* 🔹 [Decision Transformer (GitHub)](https://github.com/kzl/decision-transformer) ⭐ 2,830 | 🐛 36 | 🌐 Python | 📅 2024-04-29
...
Please raise any issues or questions [here](https://github.com/mbzuai-oryx/Awesome-LLM-Post-training/issues) ⭐ 2,526 | 🐛 15 | 🌐 Python | 📅 2026-07-27.
