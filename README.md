...
| 2  | [**LlamaGym**](https://github.com/KhoomeiK/LlamaGym) ⭐ 1,253 \| 🐛 10 \| 🌐 Python \| 📅 2024-03-19                                                                                     | Simplifies fine-tuning large language model (LLM) agents with online RL. Provides an abstract `Agent` class to handle various aspects of RL training, allowing for quick iteration and experimentation across different environments.                                                                                                                                                                               |
...
| 10 | [**Lamorel**](https://github.com/flowersteam/lamorel) ⭐ 248 \| 🐛 6 \| 🌐 Python \| 📅 2025-12-11                                                                                       | A high-throughput, distributed architecture for seamless LLM integration in interactive environments. While not specialized in RL or RLHF by default, it supports custom implementations and is ideal for users needing maximum flexibility.                                                                                                                                                                        |
...
* 🔹 [ReAct (GitHub)](https://github.com/ysymyth/ReAct) ⭐ 4,160 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-02-06
* 🔹 [Decision Transformer (GitHub)](https://github.com/kzl/decision-transformer) ⭐ 2,832 | 🐛 37 | 🌐 Python | 📅 2024-04-29
...
Please raise any issues or questions [here](https://github.com/mbzuai-oryx/Awesome-LLM-Post-training/issues) ⭐ 2,546 | 🐛 17 | 🌐 Python | 📅 2026-09-05.
